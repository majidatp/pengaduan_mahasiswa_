...
if(isset($_GET['url']))
{
    ...
    <div class="card-body">
        ...
        <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800">Tidak Ada Laporan dari Mahasiswa Yang Perlu Ditanggapi</div>
        </div>
        <div class="col-auto">
    ...
    <?php 
        ...
        <div class="card-body">
            ...
            <div class="col mr-2">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Laporan Pengaduan</div>
                <div class="h5 mb-0 font-weight-bold text-gray-800">ada <?php echo $cek; ?> Laporan dari Mahasiswa Yang Harus ditanggapi</div>
            </div>
            <div class="col-auto">
                <i class="fas fa-comments fa-4x text-gray-300"></i>
                <span class="btn btn-danger btn-circle btn-sm"><?php echo $cek; ?></span>
